...
public class CassandraHiveMetaStoreTest extends MetaStoreTestBase {
  ...
  public void testAddParition() throws Exception {
    ...
    partValues.add("cfs://localhost:9170/user/hive/warehouse/mydb.db/invites/ds=2008-08-08");
    partValues.add("cfs://localhost:9170/user/hive/warehouse/mydb.db/invites/ds=2008-08-15");
  ...
  public void testAutoCreateFromKeyspace() throws Exception {
    CassandraHiveMetaStore metaStore = new CassandraHiveMetaStore();
    Configuration conf = buildConfiguration();
    CassandraClientHolder clientHolder = new CassandraProxyClient(conf.get(SchemaManagerService.CONF_PARAM_HOST, "localhost"),
            conf.getInt(SchemaManagerService.CONF_PARAM_PORT, 9170),
